...
90 
position 0,15: print lpeek(base+4)
if change=1 then
  if ctrlstate=0 then 
  kwas+=1
  ...
  lpoke base+2160+96,$ffffffff' : 'lpeek(base+2160+96) and $20000000 
  position 0,24: print hex$(lpeek(base+2160+96),8): for i=0 to 32 step 4 : print i, hex$(lpeek(base+2304+i),8): next i
  endif
  change=0
endif 


position 20,20:print decuns$(lpeek($70),8), hex$(lpeek(base+56),8) 
midi=rm.readmidi():if midi<>0 then v.outtextxycg(2,17,hex$(midi,8),0,15)
...
'  lpoke base2+100,r2(0) : lpoke base2+104,r3(0) : lpoke base2+108,r4(0)
'  lpoke base2+112,l1(0) : lpoke base2+116,l2(0) : lpoke base2+120,l3(0) : lpoke base2+124,l4(0)
'  lpoke base2+128,b0*32 : lpoke base2+132,skip :  lpoke base2+136,feedback(0) 
