...
const ver$="P2 Retromachine BASIC version 0.04"
...
case 32              	'cls
  cls: print "" : return -1
case 33		    	'new
  cls: position 4,1 : print ver$ : print :return -1
...
function getintres(ct as integer) as integer,integer,integer ' this returns the int result, error and a new ct
