...
audio.channel1(4)=@sinus+16
audio.channel1(5)=2048
audio.channel1(6)=16384
audio.channel1(7)=8192
audio.channel1(8)=400000


startvideo()
cls
pinstart(22,P_EVENTS_TICKS,8000,3)
waitms(1000) : i=rdpin(22): let q=0
for k=1 to 200 : i=rdpin(22): pinstart(22,P_EVENTS_TICKS,8000,3) : waitms(12): let q=(4*q+i)/5 :  next k : j=q : print j: waitms(1000)
k=0
do: i=rdpin(22) : if i>j then i=i-j else i=0 
let q=(4*q+i)/5 : position 10,10: v.write(v.inttostr2((q*25)/817,8))  : audio.channel1(8)=q*25 :pinstart(22,P_EVENTS_TICKS,8000,3): v.waitvbl(1):loop
